...
def test_sweep(web3,strategy, currency,cusdc, gov, comp):
...
def test_apr_usdc(web3, chain, comp, vault, smallrunningstrategy, whale, gov, currency, strategist):
